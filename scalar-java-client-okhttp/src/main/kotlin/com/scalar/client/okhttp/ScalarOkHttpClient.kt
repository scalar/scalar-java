...
import com.scalar.client.ScalarClientImpl
...
/**
 * A class that allows building an instance of [ScalarClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class ScalarOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ScalarClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): ScalarClient = builder().fromEnv().build()
    }

    /** A builder for [ScalarOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ScalarClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScalarClient =
            ScalarClientImpl(
                clientOptions
                    .httpClient(
