...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RuleCreateRulesetParams].
         *
    ...
    /** A builder for [RuleCreateRulesetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ruleCreateRulesetParams: RuleCreateRulesetParams) = apply {
            namespace = ruleCreateRulesetParams.namespace
            body = ruleCreateRulesetParams.body.toBuilder()
            additionalHeaders = ruleCreateRulesetParams.additionalHeaders.toBuilder()
            additionalQueryParams = ruleCreateRulesetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RuleCreateRulesetParams].
         *
         ...
         */
        fun build(): RuleCreateRulesetParams =
    ...
    private constructor(
        ...
        ) : this(title, description, slug, isPrivate, document, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(title, description, slug, isPrivate, document, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{title=$title, description=$description, slug=$slug, isPrivate=$isPrivate, document=$document, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RuleCreateRulesetParams &&
    ...
    override fun toString() =
        "RuleCreateRulesetParams{namespace=$namespace, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
