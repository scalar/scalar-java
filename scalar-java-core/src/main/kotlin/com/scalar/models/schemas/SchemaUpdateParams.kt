...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SchemaUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(schemaUpdateParams: SchemaUpdateParams) = apply {
            namespace = schemaUpdateParams.namespace
            slug = schemaUpdateParams.slug
            body = schemaUpdateParams.body.toBuilder()
            additionalHeaders = schemaUpdateParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [SchemaUpdateParams].
         *
    ...
    private constructor(
        ...
        ) : this(title, description, isPrivate, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(title, description, isPrivate, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(title, description, isPrivate, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{title=$title, description=$description, isPrivate=$isPrivate, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SchemaUpdateParams &&
    ...
    override fun toString() =
        "SchemaUpdateParams{namespace=$namespace, slug=$slug, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
