...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SchemaCreateParams].
         *
    ...
    /** A builder for [SchemaCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(schemaCreateParams: SchemaCreateParams) = apply {
            namespace = schemaCreateParams.namespace
            body = schemaCreateParams.body.toBuilder()
            additionalHeaders = schemaCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = schemaCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SchemaCreateParams].
         *
    ...
    private constructor(
        ...
        ) : this(title, description, version, slug, isPrivate, document, mutableMapOf())
        ...
        override fun toString() =
            "Body{title=$title, description=$description, version=$version, slug=$slug, isPrivate=$isPrivate, document=$document, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SchemaCreateParams &&
    ...
    override fun toString() =
        "SchemaCreateParams{namespace=$namespace, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
