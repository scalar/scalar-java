package com.scalar.client.okhttp

import com.scalar.core.RequestOptions
import com.scalar.core.Timeout
import com.scalar.core.http.Headers
import com.scalar.core.http.HttpClient
import com.scalar.core.http.HttpMethod
import com.scalar.core.http.HttpRequest
import com.scalar.core.http.HttpRequestBody
import com.scalar.core.http.HttpResponse
import com.scalar.core.http.ProxyAuthenticator
import com.scalar.errors.ScalarIoException
...
class OkHttpClient internal constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw ScalarIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(ScalarIoException("Request failed", e))
                }
