...
class RegistryListAllApiDocumentsResponse
...
private constructor(
    ...
    /** A builder for [RegistryListAllApiDocumentsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            registryListAllApiDocumentsResponse: RegistryListAllApiDocumentsResponse
        ) = apply {
            uid = registryListAllApiDocumentsResponse.uid
            version = registryListAllApiDocumentsResponse.version
            title = registryListAllApiDocumentsResponse.title
            slug = registryListAllApiDocumentsResponse.slug
            description = registryListAllApiDocumentsResponse.description
            namespace = registryListAllApiDocumentsResponse.namespace
            isPrivate = registryListAllApiDocumentsResponse.isPrivate
            tags = registryListAllApiDocumentsResponse.tags
            versions = registryListAllApiDocumentsResponse.versions.map { it.toMutableList() }
            additionalProperties =
                registryListAllApiDocumentsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RegistryListAllApiDocumentsResponse].
         *
         ...
         */
        fun build(): RegistryListAllApiDocumentsResponse =
            RegistryListAllApiDocumentsResponse(
     ...
     *   expected type.
     */
    fun validate(): RegistryListAllApiDocumentsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RegistryListAllApiDocumentsResponse &&
            uid == other.uid &&
    ...
    override fun toString() =
        "RegistryListAllApiDocumentsResponse{uid=$uid, version=$version, title=$title, slug=$slug, description=$description, namespace=$namespace, isPrivate=$isPrivate, tags=$tags, versions=$versions, additionalProperties=$additionalProperties}"
}
