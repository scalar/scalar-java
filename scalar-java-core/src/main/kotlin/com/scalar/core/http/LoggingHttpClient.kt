    ...
    override fun executeAsync(
        ...
        val future =
            try {
                ...
                logFailure(e, Duration.between(before, OffsetDateTime.now(clock)))
                // Hand-completed rather than `CompletableFuture.failedFuture`, which is Java 9.
        ...
        return future.handle { response, error ->
            ...
            logResponse(
                response ?: throw IllegalStateException("Async response completed without a value"),
                took,
            )
        }
    }
