...
import com.scalar.client.ScalarClientAsyncImpl
import com.scalar.core.ClientOptions
import com.scalar.core.LogLevel
import com.scalar.core.Sleeper
...
/**
 * A class that allows building an instance of [ScalarClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ScalarOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ScalarClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): ScalarClientAsync = builder().fromEnv().build()
    }

    /** A builder for [ScalarOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.scalar.core.jsonMapper]. The default is usually sufficient and rarely
         ...
         *
         * Defaults to the production environment: `https://access.scalar.com`.
         */
        ...
        /**
         * Returns an immutable instance of [ScalarClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScalarClientAsync =
            ScalarClientAsyncImpl(
                clientOptions
                    .httpClient(
